...
wire   [47:0] trunc_ln174_fu_85_p1;
reg   [47:0] trunc_ln174_reg_119;
reg    ap_block_pp0_stage0_01001;
wire   [175:0] tmp_306_i_fu_89_p4;
reg   [0:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_i_284_nbreadreq_fu_46_p3 == 1'd1) & (tmp_i_nbreadreq_fu_38_p3 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_i_nbreadreq_fu_38_p3 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_i_284_reg_106 <= tmp_i_284_nbreadreq_fu_46_p3;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_i_284_nbreadreq_fu_46_p3 == 1'd1) & (tmp_i_nbreadreq_fu_38_p3 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (meta1_valid_fu_77_p3 == 1'd1))) begin
        trunc_ln174_reg_119 <= trunc_ln174_fu_85_p1;
    end
end
...
always @ (*) begin
    ap_predicate_op20_read_state1 = ((tmp_i_284_nbreadreq_fu_46_p3 == 1'd1) & (tmp_i_nbreadreq_fu_38_p3 == 1'd1));
end

always @ (*) begin
    ap_predicate_op22_read_state1 = ((tmp_i_284_nbreadreq_fu_46_p3 == 1'd1) & (tmp_i_nbreadreq_fu_38_p3 == 1'd1));
end

always @ (*) begin
    ap_predicate_op29_write_state2 = ((meta1_valid_reg_115 == 1'd1) & (tmp_i_284_reg_106 == 1'd1) & (tmp_i_reg_102 == 1'd1));
end
...
assign rx_ipUdpMetaFifo_din = tmp_306_i_fu_89_p4;

assign tmp_306_i_fu_89_p4 = {{{trunc_ln174_reg_119}, {96'd0}}, {meta0_their_address_V_reg_110}};

assign tmp_i_284_nbreadreq_fu_46_p3 = rx_udpMetaFifo_empty_n;

assign tmp_i_nbreadreq_fu_38_p3 = rx_ip2udpMetaFifo_empty_n;

assign trunc_ln174_fu_85_p1 = rx_udpMetaFifo_dout[47:0];
