...
module rocev2_top_ipUdpMetaHandler_512_0_s (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
input  [144:0] rx_exh2drop_MetaFifo_dout;
...
output  [144:0] rx_drop2exhFsm_MetaFifo_din;
...
wire   [0:0] tmp_i_290_nbreadreq_fu_56_p3;
wire   [0:0] tmp_261_i_nbreadreq_fu_64_p3;
...
reg   [0:0] tmp_i_290_reg_130;
reg   [0:0] tmp_261_i_reg_134;
...
reg   [15:0] meta_length_V_1_reg_138;
reg   [144:0] rx_exh2drop_MetaFifo_read_reg_143;
...
always @ (posedge ap_clk) begin
    if (((tmp_261_i_nbreadreq_fu_64_p3 == 1'd1) & (tmp_i_290_nbreadreq_fu_56_p3 == 1'd1) & (tmp_i_nbreadreq_fu_48_p3 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        meta_length_V_1_reg_138 <= {{rx_ipUdpMetaFifo_dout[175:160]}};
...
always @ (posedge ap_clk) begin
    if (((tmp_i_290_nbreadreq_fu_56_p3 == 1'd1) & (tmp_i_nbreadreq_fu_48_p3 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        tmp_261_i_reg_134 <= tmp_261_i_nbreadreq_fu_64_p3;
    end
end

always @ (posedge ap_clk) begin
    if (((tmp_i_nbreadreq_fu_48_p3 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        tmp_i_290_reg_130 <= tmp_i_290_nbreadreq_fu_56_p3;
    end
end
...
always @ (*) begin
    ap_predicate_op30_read_state1 = ((tmp_261_i_nbreadreq_fu_64_p3 == 1'd1) & (tmp_i_290_nbreadreq_fu_56_p3 == 1'd1) & (tmp_i_nbreadreq_fu_48_p3 == 1'd1));
end

always @ (*) begin
    ap_predicate_op32_read_state1 = ((tmp_261_i_nbreadreq_fu_64_p3 == 1'd1) & (tmp_i_290_nbreadreq_fu_56_p3 == 1'd1) & (tmp_i_nbreadreq_fu_48_p3 == 1'd1));
end

always @ (*) begin
    ap_predicate_op33_read_state1 = ((tmp_261_i_nbreadreq_fu_64_p3 == 1'd1) & (tmp_i_290_nbreadreq_fu_56_p3 == 1'd1) & (tmp_i_nbreadreq_fu_48_p3 == 1'd1));
end

always @ (*) begin
    ap_predicate_op40_write_state2 = ((policy_ackOnly_reg_152 == 1'd0) & (policy_isDrop_reg_148 == 1'd0) & (tmp_261_i_reg_134 == 1'd1) & (tmp_i_290_reg_130 == 1'd1) & (tmp_i_reg_126 == 1'd1));
end

always @ (*) begin
    ap_predicate_op41_write_state2 = ((policy_ackOnly_reg_152 == 1'd0) & (policy_isDrop_reg_148 == 1'd0) & (tmp_261_i_reg_134 == 1'd1) & (tmp_i_290_reg_130 == 1'd1) & (tmp_i_reg_126 == 1'd1));
end

assign exh_lengthFifo_din = meta_length_V_1_reg_138;
...
assign tmp_261_i_nbreadreq_fu_64_p3 = rx_ibhDropMetaFifo_empty_n;

assign tmp_i_290_nbreadreq_fu_56_p3 = rx_exh2drop_MetaFifo_empty_n;

assign tmp_i_nbreadreq_fu_48_p3 = rx_ipUdpMetaFifo_empty_n;

endmodule //rocev2_top_ipUdpMetaHandler_512_0_s
