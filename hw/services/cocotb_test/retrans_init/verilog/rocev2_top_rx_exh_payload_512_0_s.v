...
output   ap_idle;
output   ap_ready;
input  [31:0] rx_pkgSplitTypeFifo_dout;
...
wire   [0:0] tmp_i_179_nbreadreq_fu_72_p3;
reg    ap_predicate_op35_read_state1;
reg    ap_done_reg;
reg    ap_block_state1_pp0_stage0_iter0;
reg   [0:0] rep_state_load_reg_141;
reg   [0:0] tmp_i_179_reg_148;
reg   [31:0] meta_op_code_1_load_reg_162;
...
always @ (posedge ap_clk) begin
    if (((tmp_i_nbreadreq_fu_58_p3 == 1'd1) & (rep_state == 1'd0) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        meta_op_code_1 <= rx_pkgSplitTypeFifo_dout;
    end
end

always @ (posedge ap_clk) begin
    if (((tmp_i_179_nbreadreq_fu_72_p3 == 1'd1) & (rep_state == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        meta_op_code_1_load_reg_162 <= meta_op_code_1;
    end
end
...
always @ (posedge ap_clk) begin
    if (((rep_state == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        tmp_i_179_reg_148 <= tmp_i_179_nbreadreq_fu_72_p3;
    end
end
...
always @ (*) begin
    ap_condition_187 = ((tmp_i_179_nbreadreq_fu_72_p3 == 1'd1) & (rep_state == 1'd1) & (currWord_last_V_fu_123_p3 == 1'd1));
end
...
always @ (*) begin
    ap_predicate_op35_read_state1 = ((tmp_i_179_nbreadreq_fu_72_p3 == 1'd1) & (rep_state == 1'd1));
end

always @ (*) begin
    ap_predicate_op45_write_state2 = ((((meta_op_code_1_load_reg_162 == 32'd15) & (tmp_i_179_reg_148 == 1'd1) & (rep_state_load_reg_141 == 1'd1)) | ((meta_op_code_1_load_reg_162 == 32'd13) & (tmp_i_179_reg_148 == 1'd1) & (rep_state_load_reg_141 == 1'd1))) | ((meta_op_code_1_load_reg_162 == 32'd16) & (tmp_i_179_reg_148 == 1'd1) & (rep_state_load_reg_141 == 1'd1)));
end

always @ (*) begin
    ap_predicate_op47_write_state2 = ((((meta_op_code_1_load_reg_162 == 32'd6) & (tmp_i_179_reg_148 == 1'd1) & (rep_state_load_reg_141 == 1'd1)) | ((meta_op_code_1_load_reg_162 == 32'd12) & (tmp_i_179_reg_148 == 1'd1) & (rep_state_load_reg_141 == 1'd1))) | ((meta_op_code_1_load_reg_162 == 32'd10) & (tmp_i_179_reg_148 == 1'd1) & (rep_state_load_reg_141 == 1'd1)));
end

always @ (*) begin
    ap_predicate_op49_write_state2 = (~(meta_op_code_1_load_reg_162 == 32'd16) & ~(meta_op_code_1_load_reg_162 == 32'd15) & ~(meta_op_code_1_load_reg_162 == 32'd13) & ~(meta_op_code_1_load_reg_162 == 32'd10) & ~(meta_op_code_1_load_reg_162 == 32'd6) & ~(meta_op_code_1_load_reg_162 == 32'd12) & (tmp_i_179_reg_148 == 1'd1) & (rep_state_load_reg_141 == 1'd1));
end
...
assign tmp_i_179_nbreadreq_fu_72_p3 = rx_ibhDrop2exhFifo_empty_n;
