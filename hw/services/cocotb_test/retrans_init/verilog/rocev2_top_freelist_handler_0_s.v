...
wire   [0:0] icmp_ln1073_fu_74_p2;
wire   [0:0] tmp_i_302_nbwritereq_fu_50_p3;
reg    ap_predicate_op23_write_state2;
reg    ap_block_state2_pp0_stage0_iter1;
reg    ap_block_pp0_stage0_subdone;
reg   [10:0] freeListCounter_V;
reg    rt_releaseFifo_blk_n;
wire    ap_block_pp0_stage0;
reg    rt_freeListFifo_blk_n;
reg    ap_block_pp0_stage0_11001;
reg   [15:0] tmp_reg_96;
wire   [10:0] add_ln886_fu_80_p2;
wire   [15:0] zext_ln1073_fu_69_p1;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        freeListCounter_V <= 11'd0;
    end else begin
        if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_i_302_nbwritereq_fu_50_p3 == 1'd1) & (icmp_ln1073_fu_74_p2 == 1'd1) & (tmp_i_reg_92 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            freeListCounter_V <= add_ln886_fu_80_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_i_nbreadreq_fu_36_p3 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_reg_96 <= rt_releaseFifo_dout;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_condition_117)) begin
        if ((tmp_i_reg_92 == 1'd1)) begin
            rt_freeListFifo_din = tmp_reg_96;
        end else if ((ap_predicate_op23_write_state2 == 1'b1)) begin
            rt_freeListFifo_din = zext_ln1073_fu_69_p1;
        end else begin
...
assign add_ln886_fu_80_p2 = (freeListCounter_V + 11'd1);
...
always @ (*) begin
    ap_predicate_op23_write_state2 = ((tmp_i_302_nbwritereq_fu_50_p3 == 1'd1) & (icmp_ln1073_fu_74_p2 == 1'd1) & (tmp_i_reg_92 == 1'd0));
end

assign icmp_ln1073_fu_74_p2 = ((freeListCounter_V < 11'd2000) ? 1'b1 : 1'b0);

assign tmp_i_302_nbwritereq_fu_50_p3 = rt_freeListFifo_full_n;

assign tmp_i_nbreadreq_fu_36_p3 = rt_releaseFifo_empty_n;

assign zext_ln1073_fu_69_p1 = freeListCounter_V;
