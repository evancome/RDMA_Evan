...
reg   [0:0] tmp_3_i_reg_248;
reg    ap_predicate_op79_write_state2;
reg   [0:0] tmp_i_164_reg_255;
reg    ap_predicate_op81_write_state2;
reg   [0:0] tmp_2_i_reg_262;
...
wire   [1:0] select_ln1239_1_fu_230_p3;
wire   [0:0] grp_fu_126_p2;
wire   [7:0] grp_fu_115_p2;
reg    ap_block_pp0_stage0_01001;
wire   [0:0] grp_fu_120_p2;
wire   [0:0] grp_fu_107_p3;
wire   [31:0] trunc_ln145_fu_194_p1;
wire   [0:0] icmp_ln1239_1_fu_210_p2;
wire   [0:0] icmp_ln1239_fu_204_p2;
wire   [0:0] or_ln1239_fu_224_p2;
wire   [1:0] select_ln1239_fu_216_p3;
reg   [0:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (((tmp_i_nbreadreq_fu_72_p3 == 1'd1) & (state == 2'd0) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        state <= select_ln1239_1_fu_230_p3;
...
always @ (*) begin
    ap_predicate_op79_write_state2 = ((tmp_3_i_reg_248 == 1'd1) & (state_load_reg_244 == 2'd2));
end

always @ (*) begin
    ap_predicate_op81_write_state2 = ((state_load_reg_244 == 2'd1) & (tmp_i_164_reg_255 == 1'd1));
end

always @ (*) begin
    ap_predicate_op83_write_state2 = ((state_load_reg_244 == 2'd3) & (tmp_2_i_reg_262 == 1'd1));
end
...
assign icmp_ln1239_1_fu_210_p2 = ((trunc_ln145_fu_194_p1 == 32'd0) ? 1'b1 : 1'b0);

assign icmp_ln1239_fu_204_p2 = ((trunc_ln145_fu_194_p1 == 32'd1) ? 1'b1 : 1'b0);

assign or_ln1239_fu_224_p2 = (icmp_ln1239_fu_204_p2 | icmp_ln1239_1_fu_210_p2);

assign select_ln1239_1_fu_230_p3 = ((or_ln1239_fu_224_p2[0:0] == 1'b1) ? select_ln1239_fu_216_p3 : 2'd3);

assign select_ln1239_fu_216_p3 = ((icmp_ln1239_1_fu_210_p2[0:0] == 1'b1) ? 2'd1 : 2'd2);

assign tmp_i_nbreadreq_fu_72_p3 = tx_pkgInfoFifo_empty_n;

assign trunc_ln145_fu_194_p1 = tx_pkgInfoFifo_dout[31:0];
