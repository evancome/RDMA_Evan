...
reg   [15:0] tmp_13_i6_reg_161;
reg    ap_block_pp0_stage0_01001;
wire   [175:0] tmp_14_i_fu_118_p5;
wire   [175:0] or_ln174_fu_127_p2;
reg   [0:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_i_165_nbreadreq_fu_60_p3 == 1'd1) & (tmp_i_nbreadreq_fu_52_p3 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_13_i6_reg_161 <= {{tx_connTable2ibh_rsp_dout[271:256]}};
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_i_nbreadreq_fu_52_p3 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_i_165_reg_142 <= tmp_i_165_nbreadreq_fu_60_p3;
    end
end
...
always @ (*) begin
    ap_predicate_op24_read_state1 = ((tmp_i_165_nbreadreq_fu_60_p3 == 1'd1) & (tmp_i_nbreadreq_fu_52_p3 == 1'd1));
end

always @ (*) begin
    ap_predicate_op27_read_state1 = ((tmp_i_165_nbreadreq_fu_60_p3 == 1'd1) & (tmp_i_nbreadreq_fu_52_p3 == 1'd1));
end

always @ (*) begin
    ap_predicate_op32_write_state2 = ((tmp_i_165_reg_142 == 1'd1) & (tmp_i_reg_138 == 1'd1));
end

always @ (*) begin
    ap_predicate_op33_write_state2 = ((tmp_i_165_reg_142 == 1'd1) & (tmp_i_reg_138 == 1'd1));
end

assign connMeta_remote_qpn_V_fu_94_p1 = tx_connTable2ibh_rsp_dout[23:0];

assign or_ln174_fu_127_p2 = (tmp_14_i_fu_118_p5 | 176'd1630292819918216178453027744205601501085696);

assign tmp_14_i_fu_118_p5 = {{{{len_reg_156}, {tmp_13_i6_reg_161}}, {16'd0}}, {connMeta_remote_ip_address_V_reg_151}};

assign tmp_i_165_nbreadreq_fu_60_p3 = tx_lengthFifo_empty_n;

assign tmp_i_nbreadreq_fu_52_p3 = tx_connTable2ibh_rsp_empty_n;

assign tx_dstQpFifo_din = connMeta_remote_qpn_V_reg_146;

assign tx_ipUdpMetaFifo_din = or_ln174_fu_127_p2;
