...
entity rocev2_top_fifo_w96_d16_A is
    generic (
...
architecture arch of rocev2_top_fifo_w96_d16_A is

    -- component
    component rocev2_top_fifo_w96_d16_A_ram is
    generic (
        MEM_STYLE  : string  := "auto";
...
begin
----------------------- Instantiation -----------------------
    U_rocev2_top_fifo_w96_d16_A_ram : rocev2_top_fifo_w96_d16_A_ram
    generic map (
        MEM_STYLE  => MEM_STYLE,
...
entity rocev2_top_fifo_w96_d16_A_ram is
    generic (
        MEM_STYLE   : string  := "auto";
        DATA_WIDTH  : integer := 96;
        ADDR_WIDTH  : integer := 4;
...
architecture arch of rocev2_top_fifo_w96_d16_A_ram is
