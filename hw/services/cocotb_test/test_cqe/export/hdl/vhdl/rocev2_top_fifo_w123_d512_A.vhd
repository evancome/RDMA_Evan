...
entity rocev2_top_fifo_w123_d512_A is
    generic (
...
architecture arch of rocev2_top_fifo_w123_d512_A is

    -- component
    component rocev2_top_fifo_w123_d512_A_ram is
    generic (
        MEM_STYLE  : string  := "auto";
        DATA_WIDTH : natural := 123;
...
begin
----------------------- Instantiation -----------------------
    U_rocev2_top_fifo_w123_d512_A_ram : rocev2_top_fifo_w123_d512_A_ram
    generic map (
        MEM_STYLE  => MEM_STYLE,
...
entity rocev2_top_fifo_w123_d512_A_ram is
    generic (
        MEM_STYLE   : string  := "auto";
        DATA_WIDTH  : integer := 123;
        ADDR_WIDTH  : integer := 9;
...
architecture arch of rocev2_top_fifo_w123_d512_A_ram is
