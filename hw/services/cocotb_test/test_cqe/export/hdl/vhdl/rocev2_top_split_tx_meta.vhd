...
attribute shreg_extract : string;
    ...
    signal meta_length_V_1_reg_143 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp_i_174_reg_148 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_30_i_reg_153 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal tempLen_V_fu_108_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp_29_i_fu_113_p3 : STD_LOGIC_VECTOR (47 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (tmp_i_nbreadreq_fu_50_p3 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                meta_length_V_1_reg_143 <= tx_ipUdpMetaFifo_dout(175 downto 160);
                tmp_30_i_reg_153 <= tx_ipUdpMetaFifo_dout(159 downto 128);
                tmp_i_174_reg_148 <= tx_ipUdpMetaFifo_dout(127 downto 96);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    tempLen_V_fu_108_p2 <= std_logic_vector(unsigned(meta_length_V_1_reg_143) + unsigned(ap_const_lv16_8));
    tmp_29_i_fu_113_p3 <= (tempLen_V_fu_108_p2 & tmp_i_174_reg_148);
    ...
    tx_udp2ipMetaFifo_din <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_29_i_fu_113_p3),64));
    ...
    zext_ln173_cast_fu_125_p4 <= ((ap_const_lv1_1 & tempLen_V_fu_108_p2) & tmp_30_i_reg_153);
end behav;
