...
entity rocev2_top_fifo_w151_d512_A is
    generic (
...
architecture arch of rocev2_top_fifo_w151_d512_A is

    -- component
    component rocev2_top_fifo_w151_d512_A_ram is
    generic (
        MEM_STYLE  : string  := "auto";
        DATA_WIDTH : natural := 151;
...
begin
----------------------- Instantiation -----------------------
    U_rocev2_top_fifo_w151_d512_A_ram : rocev2_top_fifo_w151_d512_A_ram
    generic map (
        MEM_STYLE  => MEM_STYLE,
...
entity rocev2_top_fifo_w151_d512_A_ram is
    generic (
        MEM_STYLE   : string  := "auto";
        DATA_WIDTH  : integer := 151;
        ADDR_WIDTH  : integer := 9;
...
architecture arch of rocev2_top_fifo_w151_d512_A_ram is
