...
wire   [0:0] tmp_i_300_nbreadreq_fu_66_p3;
reg    ap_predicate_op20_read_state1;
reg    ap_predicate_op21_read_state1;
reg    ap_done_reg;
reg    ap_block_state1_pp0_stage0_iter0;
reg   [0:0] tmp_i_reg_153;
reg   [0:0] tmp_i_300_reg_157;
...
wire   [15:0] trunc_ln2696_fu_93_p1;
reg   [15:0] trunc_ln2696_reg_161;
reg   [23:0] tmp_323_i3_reg_166;
reg   [4:0] tmp_4_reg_171;
reg   [3:0] tmp_s_reg_176;
wire   [160:0] trunc_ln2696_1_fu_127_p1;
reg   [160:0] trunc_ln2696_1_reg_181;
reg    ap_block_pp0_stage0_01001;
wire   [299:0] or_ln2696_4_fu_131_p10;
reg   [0:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_i_300_nbreadreq_fu_66_p3 == 1'd1) & (tmp_i_nbreadreq_fu_58_p3 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_323_i3_reg_166 <= {{tx2retrans_insertMeta_dout[55:32]}};
        tmp_4_reg_171 <= {{tx2retrans_insertMeta_dout[68:64]}};
        tmp_s_reg_176 <= {{tx2retrans_insertAddrLen_dout[171:168]}};
...
always @ (*) begin
    ap_predicate_op20_read_state1 = ((tmp_i_300_nbreadreq_fu_66_p3 == 1'd1) & (tmp_i_nbreadreq_fu_58_p3 == 1'd1));
end

always @ (*) begin
    ap_predicate_op21_read_state1 = ((tmp_i_300_nbreadreq_fu_66_p3 == 1'd1) & (tmp_i_nbreadreq_fu_58_p3 == 1'd1));
end

always @ (*) begin
    ap_predicate_op29_write_state2 = ((tmp_i_300_reg_157 == 1'd1) & (tmp_i_reg_153 == 1'd1));
end

assign or_ln2696_4_fu_131_p10 = {{{{{{{{{tmp_s_reg_176}, {7'd0}}, {trunc_ln2696_1_reg_181}}, {59'd0}}, {tmp_4_reg_171}}, {8'd0}}, {tmp_323_i3_reg_166}}, {16'd0}}, {trunc_ln2696_reg_161}};

assign tmp_i_300_nbreadreq_fu_66_p3 = tx2retrans_insertAddrLen_empty_n;

assign tmp_i_nbreadreq_fu_58_p3 = tx2retrans_insertMeta_empty_n;

assign trunc_ln2696_1_fu_127_p1 = tx2retrans_insertAddrLen_dout[160:0];

assign trunc_ln2696_fu_93_p1 = tx2retrans_insertMeta_dout[15:0];

assign tx2retrans_insertRequest_din = or_ln2696_4_fu_131_p10;
