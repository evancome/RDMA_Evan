...
reg   [7:0] reg_140;
wire   [447:0] trunc_ln628_fu_180_p1;
reg   [447:0] trunc_ln628_reg_338;
reg   [55:0] tmp_9_i7_reg_344;
...
wire   [1023:0] zext_ln1089_fu_299_p1;
reg    ap_block_pp0_stage0_01001;
wire   [1023:0] zext_ln1056_fu_322_p1;
wire   [7:0] tmp_1_i8_fu_194_p4;
...
wire   [577:0] or_ln1089_1_i_fu_288_p5;
wire   [576:0] zext_ln1056_cast_fu_310_p5;
reg   [0:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_7_i_reg_331 == 1'd1) & (ls_writeRemainder_load_reg_327 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_7_i_nbreadreq_fu_84_p3 == 1'd1) & (ls_writeRemainder == 1'd0) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if ((((1'b0 == ap_block_pp0_stage0_11001) & (tmp_7_i_nbreadreq_fu_84_p3 == 1'd1) & (ls_writeRemainder == 1'd0) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((1'b0 == ap_block_pp0_stage0_11001) & (ls_writeRemainder_load_load_fu_144_p1 == 1'd1) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_7_i_nbreadreq_fu_84_p3 == 1'd1) & (ls_writeRemainder == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        sendWord_last_V_reg_350 <= sendWord_last_V_fu_204_p2;
        tmp_9_i7_reg_344 <= {{tx_ib2udpFifo_dout[567:512]}};
...
always @ (*) begin
    ap_condition_131 = ((tmp_7_i_nbreadreq_fu_84_p3 == 1'd1) & (ls_writeRemainder == 1'd0) & (currWord_last_V_fu_172_p3 == 1'd1));
end

always @ (*) begin
    ap_condition_135 = ((tmp_7_i_nbreadreq_fu_84_p3 == 1'd1) & (ls_writeRemainder == 1'd0) & (currWord_last_V_fu_172_p3 == 1'd0));
end
...
always @ (*) begin
    ap_predicate_op18_read_state1 = ((tmp_7_i_nbreadreq_fu_84_p3 == 1'd1) & (ls_writeRemainder == 1'd0));
end

always @ (*) begin
    ap_predicate_op47_write_state2 = ((tmp_7_i_reg_331 == 1'd1) & (ls_writeRemainder_load_reg_327 == 1'd0));
end
...
assign or_ln1089_1_i_fu_288_p5 = {{{{{{1'd0}, {sendWord_last_V_reg_350}}}, {select_ln1070_fu_280_p3}}}, {sendWord_data_V_2_fu_272_p3}};

assign p_Result_1_fu_251_p3 = {{tmp_9_i7_reg_344}, {8'd255}};

assign p_Result_2_fu_258_p3 = {{trunc_ln628_reg_338}, {reg_136}};

assign p_Result_3_fu_265_p3 = {{tmp_9_i7_reg_344}, {reg_140}};

assign p_Result_s_fu_244_p3 = {{trunc_ln628_reg_338}, {64'd0}};
...
assign sendWord_last_V_fu_204_p2 = ((tmp_1_i8_fu_194_p4 == 8'd0) ? 1'b1 : 1'b0);

assign tmp_1_i8_fu_194_p4 = {{tx_ib2udpFifo_dout[575:568]}};

assign tmp_7_i_nbreadreq_fu_84_p3 = tx_ib2udpFifo_empty_n;

assign trunc_ln628_fu_180_p1 = tx_ib2udpFifo_dout[447:0];

assign xor_ln901_fu_222_p2 = (sendWord_last_V_fu_204_p2 ^ 1'd1);

assign zext_ln1056_cast_fu_310_p5 = {{{{{{57'd72057594037927936}, {reg_140}}}, {448'd0}}}, {reg_136}};

assign zext_ln1056_fu_322_p1 = zext_ln1056_cast_fu_310_p5;

assign zext_ln1089_fu_299_p1 = or_ln1089_1_i_fu_288_p5;
