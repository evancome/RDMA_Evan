...
wire   [0:0] tmp_288_i_nbreadreq_fu_64_p3;
...
reg   [0:0] tmp_i_305_reg_130;
reg   [0:0] tmp_288_i_reg_134;
...
always @ (posedge ap_clk) begin
    if (((tmp_288_i_nbreadreq_fu_64_p3 == 1'd1) & (tmp_i_305_nbreadreq_fu_56_p3 == 1'd1) & (tmp_i_nbreadreq_fu_48_p3 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if (((tmp_i_305_nbreadreq_fu_56_p3 == 1'd1) & (tmp_i_nbreadreq_fu_48_p3 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    ap_predicate_op30_read_state1 = ((tmp_288_i_nbreadreq_fu_64_p3 == 1'd1) & (tmp_i_305_nbreadreq_fu_56_p3 == 1'd1) & (tmp_i_nbreadreq_fu_48_p3 == 1'd1));
end

always @ (*) begin
    ap_predicate_op32_read_state1 = ((tmp_288_i_nbreadreq_fu_64_p3 == 1'd1) & (tmp_i_305_nbreadreq_fu_56_p3 == 1'd1) & (tmp_i_nbreadreq_fu_48_p3 == 1'd1));
end

always @ (*) begin
    ap_predicate_op33_read_state1 = ((tmp_288_i_nbreadreq_fu_64_p3 == 1'd1) & (tmp_i_305_nbreadreq_fu_56_p3 == 1'd1) & (tmp_i_nbreadreq_fu_48_p3 == 1'd1));
end

always @ (*) begin
    ap_predicate_op40_write_state2 = ((policy_ackOnly_reg_152 == 1'd0) & (policy_isDrop_reg_148 == 1'd0) & (tmp_288_i_reg_134 == 1'd1) & (tmp_i_305_reg_130 == 1'd1) & (tmp_i_reg_126 == 1'd1));
end

always @ (*) begin
    ap_predicate_op41_write_state2 = ((policy_ackOnly_reg_152 == 1'd0) & (policy_isDrop_reg_148 == 1'd0) & (tmp_288_i_reg_134 == 1'd1) & (tmp_i_305_reg_130 == 1'd1) & (tmp_i_reg_126 == 1'd1));
end
...
assign tmp_288_i_nbreadreq_fu_64_p3 = rx_ibhDropMetaFifo_empty_n;

assign tmp_i_305_nbreadreq_fu_56_p3 = rx_exh2drop_MetaFifo_empty_n;
