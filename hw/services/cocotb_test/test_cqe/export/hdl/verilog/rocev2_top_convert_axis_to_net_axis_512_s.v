...
module rocev2_top_convert_axis_to_net_axis_512_s (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_done_reg == 1'b1) | ((tmp_reg_99 == 1'd1) & (s_axis_rx_data_internal_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_start == 1'b1) & ((ap_done_reg == 1'b1) | ((tmp_nbreadreq_fu_42_p6 == 1'd1) & (s_axis_rx_data_TVALID_int_regslice == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_done_reg == 1'b1) | ((tmp_reg_99 == 1'd1) & (s_axis_rx_data_internal_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_start == 1'b1) & ((ap_done_reg == 1'b1) | ((tmp_nbreadreq_fu_42_p6 == 1'd1) & (s_axis_rx_data_TVALID_int_regslice == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_done_reg == 1'b1) | ((tmp_reg_99 == 1'd1) & (s_axis_rx_data_internal_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_start == 1'b1) & ((ap_done_reg == 1'b1) | ((tmp_nbreadreq_fu_42_p6 == 1'd1) & (s_axis_rx_data_TVALID_int_regslice == 1'b0)))));
end

always @ (*) begin
    ap_block_state1_pp0_stage0_iter0 = ((ap_done_reg == 1'b1) | ((tmp_nbreadreq_fu_42_p6 == 1'd1) & (s_axis_rx_data_TVALID_int_regslice == 1'b0)));
end

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((tmp_reg_99 == 1'd1) & (s_axis_rx_data_internal_full_n == 1'b0));
end
...
assign s_axis_rx_data_internal_din = tmp_495_i_fu_87_p4;

assign tmp_495_i_fu_87_p4 = {{{tmp_last_V_reg_113}, {tmp_keep_V_reg_108}}, {tmp_data_V_reg_103}};

assign tmp_nbreadreq_fu_42_p6 = s_axis_rx_data_TVALID_int_regslice;

endmodule //rocev2_top_convert_axis_to_net_axis_512_s
