...
reg   [31:0] tmp_i_174_reg_148;
reg   [31:0] tmp_30_i_reg_153;
reg    ap_block_pp0_stage0_01001;
wire   [15:0] tempLen_V_fu_108_p2;
wire   [47:0] tmp_29_i_fu_113_p3;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_i_nbreadreq_fu_50_p3 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_30_i_reg_153 <= {{tx_ipUdpMetaFifo_dout[159:128]}};
        tmp_i_174_reg_148 <= {{tx_ipUdpMetaFifo_dout[127:96]}};
    end
end
...
assign tmp_29_i_fu_113_p3 = {{tempLen_V_fu_108_p2}, {tmp_i_174_reg_148}};

assign tmp_i_nbreadreq_fu_50_p3 = tx_ipUdpMetaFifo_empty_n;

assign tx_udp2ipMetaFifo_din = tmp_29_i_fu_113_p3;

assign tx_udpMetaFifo_din = zext_ln173_cast_fu_125_p4;

assign zext_ln173_cast_fu_125_p4 = {{{{1'd1}, {tempLen_V_fu_108_p2}}}, {tmp_30_i_reg_153}};
