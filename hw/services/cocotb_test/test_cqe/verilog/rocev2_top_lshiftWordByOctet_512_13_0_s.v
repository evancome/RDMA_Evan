...
reg   [15:0] reg_140;
wire   [383:0] trunc_ln628_fu_180_p1;
reg   [383:0] trunc_ln628_reg_338;
reg   [47:0] tmp_244_i7_reg_344;
...
wire   [15:0] tmp_245_i8_fu_194_p4;
wire   [511:0] p_Result_s_fu_244_p3;
wire   [511:0] p_Result_12_fu_258_p3;
wire   [63:0] p_Result_11_fu_251_p3;
wire   [63:0] p_Result_13_fu_265_p3;
wire   [63:0] select_ln543_fu_280_p3;
wire   [511:0] sendWord_data_V_4_fu_272_p3;
wire   [577:0] or_ln562_1_i_fu_288_p5;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_242_i_reg_331 == 1'd1) & (ls_writeRemainder_1_load_reg_327 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_242_i_nbreadreq_fu_84_p3 == 1'd1) & (ls_writeRemainder_1 == 1'd0) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if ((((1'b0 == ap_block_pp0_stage0_11001) & (tmp_242_i_nbreadreq_fu_84_p3 == 1'd1) & (ls_writeRemainder_1 == 1'd0) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((1'b0 == ap_block_pp0_stage0_11001) & (ls_writeRemainder_1_load_load_fu_144_p1 == 1'd1) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_242_i_nbreadreq_fu_84_p3 == 1'd1) & (ls_writeRemainder_1 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        sendWord_last_V_reg_350 <= sendWord_last_V_fu_204_p2;
        tmp_244_i7_reg_344 <= {{tx_rethMerge2rethShift_dout[559:512]}};
...
always @ (*) begin
    ap_condition_131 = ((tmp_242_i_nbreadreq_fu_84_p3 == 1'd1) & (ls_writeRemainder_1 == 1'd0) & (currWord_last_V_fu_172_p3 == 1'd1));
end

always @ (*) begin
    ap_condition_135 = ((tmp_242_i_nbreadreq_fu_84_p3 == 1'd1) & (ls_writeRemainder_1 == 1'd0) & (currWord_last_V_fu_172_p3 == 1'd0));
end
...
always @ (*) begin
    ap_predicate_op18_read_state1 = ((tmp_242_i_nbreadreq_fu_84_p3 == 1'd1) & (ls_writeRemainder_1 == 1'd0));
end

always @ (*) begin
    ap_predicate_op47_write_state2 = ((tmp_242_i_reg_331 == 1'd1) & (ls_writeRemainder_1_load_reg_327 == 1'd0));
end
...
assign or_ln562_1_i_fu_288_p5 = {{{{{{1'd0}, {sendWord_last_V_reg_350}}}, {select_ln543_fu_280_p3}}}, {sendWord_data_V_4_fu_272_p3}};

assign p_Result_11_fu_251_p3 = {{tmp_244_i7_reg_344}, {16'd65535}};

assign p_Result_12_fu_258_p3 = {{trunc_ln628_reg_338}, {reg_136}};

assign p_Result_13_fu_265_p3 = {{tmp_244_i7_reg_344}, {reg_140}};

assign p_Result_s_fu_244_p3 = {{trunc_ln628_reg_338}, {128'd0}};

assign select_ln543_fu_280_p3 = ((ls_firstWord_1[0:0] == 1'b1) ? p_Result_11_fu_251_p3 : p_Result_13_fu_265_p3);

assign sendWord_data_V_4_fu_272_p3 = ((ls_firstWord_1[0:0] == 1'b1) ? p_Result_s_fu_244_p3 : p_Result_12_fu_258_p3);

assign sendWord_last_V_fu_204_p2 = ((tmp_245_i8_fu_194_p4 == 16'd0) ? 1'b1 : 1'b0);

assign tmp_242_i_nbreadreq_fu_84_p3 = tx_rethMerge2rethShift_empty_n;

assign tmp_245_i8_fu_194_p4 = {{tx_rethMerge2rethShift_dout[575:560]}};

assign trunc_ln628_fu_180_p1 = tx_rethMerge2rethShift_dout[383:0];

assign xor_ln901_fu_222_p2 = (sendWord_last_V_fu_204_p2 ^ 1'd1);

assign zext_ln529_cast_fu_310_p5 = {{{{{{49'd281474976710656}, {reg_140}}}, {384'd0}}}, {reg_136}};

assign zext_ln529_fu_322_p1 = zext_ln529_cast_fu_310_p5;

assign zext_ln562_fu_299_p1 = or_ln562_1_i_fu_288_p5;
