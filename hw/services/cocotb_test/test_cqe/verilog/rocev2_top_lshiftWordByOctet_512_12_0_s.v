...
reg   [3:0] reg_138;
wire   [479:0] trunc_ln628_fu_178_p1;
reg   [479:0] trunc_ln628_reg_336;
reg   [59:0] tmp_250_i7_reg_342;
...
wire   [0:0] xor_ln901_fu_220_p2;
wire   [511:0] currWord_data_V_fu_156_p1;
wire   [1023:0] zext_ln562_fu_297_p1;
reg    ap_block_pp0_stage0_01001;
wire   [1023:0] zext_ln529_fu_320_p1;
wire   [3:0] tmp_251_i8_fu_192_p4;
wire   [511:0] p_Result_s_fu_242_p3;
wire   [511:0] p_Result_15_fu_256_p3;
wire   [63:0] p_Result_14_fu_249_p3;
wire   [63:0] p_Result_16_fu_263_p3;
wire   [63:0] select_ln543_fu_278_p3;
wire   [511:0] sendWord_data_V_6_fu_270_p3;
wire   [577:0] or_ln562_2_i_fu_286_p5;
wire   [576:0] zext_ln529_cast_fu_308_p5;
reg   [0:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_248_i_reg_329 == 1'd1) & (ls_writeRemainder_2_load_reg_325 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_248_i_nbreadreq_fu_82_p3 == 1'd1) & (ls_writeRemainder_2 == 1'd0) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if ((((1'b0 == ap_block_pp0_stage0_11001) & (tmp_248_i_nbreadreq_fu_82_p3 == 1'd1) & (ls_writeRemainder_2 == 1'd0) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((1'b0 == ap_block_pp0_stage0_11001) & (ls_writeRemainder_2_load_load_fu_142_p1 == 1'd1) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_248_i_nbreadreq_fu_82_p3 == 1'd1) & (ls_writeRemainder_2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        sendWord_last_V_reg_348 <= sendWord_last_V_fu_202_p2;
        tmp_250_i7_reg_342 <= {{tx_split2aethShift_dout[571:512]}};
...
always @ (*) begin
    ap_condition_131 = ((tmp_248_i_nbreadreq_fu_82_p3 == 1'd1) & (ls_writeRemainder_2 == 1'd0) & (currWord_last_V_fu_170_p3 == 1'd1));
end

always @ (*) begin
    ap_condition_135 = ((tmp_248_i_nbreadreq_fu_82_p3 == 1'd1) & (ls_writeRemainder_2 == 1'd0) & (currWord_last_V_fu_170_p3 == 1'd0));
end
...
always @ (*) begin
    ap_predicate_op18_read_state1 = ((tmp_248_i_nbreadreq_fu_82_p3 == 1'd1) & (ls_writeRemainder_2 == 1'd0));
end

always @ (*) begin
    ap_predicate_op47_write_state2 = ((tmp_248_i_reg_329 == 1'd1) & (ls_writeRemainder_2_load_reg_325 == 1'd0));
end
...
assign or_ln562_2_i_fu_286_p5 = {{{{{{1'd0}, {sendWord_last_V_reg_348}}}, {select_ln543_fu_278_p3}}}, {sendWord_data_V_6_fu_270_p3}};

assign p_Result_14_fu_249_p3 = {{tmp_250_i7_reg_342}, {4'd15}};

assign p_Result_15_fu_256_p3 = {{trunc_ln628_reg_336}, {reg_134}};

assign p_Result_16_fu_263_p3 = {{tmp_250_i7_reg_342}, {reg_138}};

assign p_Result_s_fu_242_p3 = {{trunc_ln628_reg_336}, {32'd0}};

assign select_ln543_fu_278_p3 = ((ls_firstWord_2[0:0] == 1'b1) ? p_Result_14_fu_249_p3 : p_Result_16_fu_263_p3);

assign sendWord_data_V_6_fu_270_p3 = ((ls_firstWord_2[0:0] == 1'b1) ? p_Result_s_fu_242_p3 : p_Result_15_fu_256_p3);

assign sendWord_last_V_fu_202_p2 = ((tmp_251_i8_fu_192_p4 == 4'd0) ? 1'b1 : 1'b0);

assign tmp_248_i_nbreadreq_fu_82_p3 = tx_split2aethShift_empty_n;

assign tmp_251_i8_fu_192_p4 = {{tx_split2aethShift_dout[575:572]}};

assign trunc_ln628_fu_178_p1 = tx_split2aethShift_dout[479:0];

assign xor_ln901_fu_220_p2 = (sendWord_last_V_fu_202_p2 ^ 1'd1);

assign zext_ln529_cast_fu_308_p5 = {{{{{{61'd1152921504606846976}, {reg_138}}}, {480'd0}}}, {reg_134}};

assign zext_ln529_fu_320_p1 = zext_ln529_cast_fu_308_p5;

assign zext_ln562_fu_297_p1 = or_ln562_2_i_fu_286_p5;
